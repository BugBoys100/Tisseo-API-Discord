...
module.exports = {
  ...
  description: "Envoie l'invitation du bot", //the command description for helpcmd [OPTIONAL]
  ...
  run: async (client, message, args, plusArgs, cmdUser, text, prefix) => {
    try {
      message.reply(`https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot%20applications.commands`);
    } catch (e) {
